...
\begin{itemize}
  \setlength\itemsep{0em}
  \item[{[10]}] Renard F, \textbf{Devleesschauwer B} (2019) Health Status Report 2019: De gezondheidstoestand in Belgi\"{e}. Brussels, Belgium: Sciensano; 48p. Report number D/2019/14.440/4. \url{https://doi.org/10.25608/reh4-ty02}
  \item[{[9]}] Renard F, \textbf{Devleesschauwer B} (2019) Health Status Report 2019: L'\'{e}tat de sant\'{e} en Belgique. Brussels, Belgium: Sciensano; 48p. Report number D/2019/14.440/3. \url{https://doi.org/10.25608/a42z-ah78}
