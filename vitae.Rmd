...
* **Computational Task Force member**, 2011--present  
    **Country Studies Task Force member**, 2011--present  
    Foodborne Disease Burden Epidemiology Reference Group, WHO

### Participation in international development projects

* **USAID Feed the Future Innovation Lab on Livestock Systems**, 2015--2020  
...
* **VLIR-UOS Institutional University Cooperation with Jimma University, Ethiopia**, 2012--2016  
...
* Expert consultation to discuss preliminary results of the joint WHO/IHME analysis of causes of death among children aged 5--14 years in the WHO European Region. Copenhagen, Denmark; 2015.
...
* FAO/WHO Expert Meeting on Risk-based examples for Control of _Trichinella} spp. and _Taenia saginata} in meat. Geneva, Switzerland; 2013--2014.
...
* **Topics in tropical veterinary medicine**, 2013--2015   
...
* **Fabian Dupont**, October 2015   
    MSc Medicine, Technische Universit\"{a}t M\"{u}nchen   
...
```{r, echo=FALSE, results='asis'}
cat(sprintf("### Submitted papers (%d)", nrow(db)))
```
