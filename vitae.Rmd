...
### Supervision of PhD students (1)

* **Sofie Theresa Thomsen**, 2016--2018   
    PhD Nutrition, National Food Institute, Danish Technical University  
    Risk-benefit assessment of whole diet  
...
cat(sprintf("### Supervision of MSc students (%d)\n", nrow(db_msc)))
...
cat(sprintf("### Supervision of BSc students (%d)\n", nrow(db_bsc)))

for (i in seq(nrow(db_bsc)))
  print_student(db_bsc[i, ], nrow(db_bsc) - i + 1)
```

### Supervision of short-term scientific missions (4)
...
### Member of PhD examination committees (3)
