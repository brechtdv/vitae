...
\textit{Sciensano, Department of Epidemiology and Surveillance}\\
\textit{Center for Burden and Risk Assessment---\href{http://www.cbra.be}{www.cbra.be}}\\
\href{mailto:brecht.devleesschauwer@sciensano.be}{brecht.devleesschauwer@sciensano.be} $\mid$ Skype: \href{skype:brecht.devleesschauwer?call>}{brecht.devleesschauwer}\\
...
\begin{itemize}
  ...
  \item \textbf{Senior epidemiologist}, 04/2018--present \hfill \\
    Sciensano, Brussels, Belgium
  \item \textbf{Senior epidemiologist}, 04/2016--03/2018 \hfill \\
...
\subsection{PhD examination committees (4)}
\begin{itemize}
  \setlength\itemsep{0em}
