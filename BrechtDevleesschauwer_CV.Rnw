...
\href{mailto:brecht.devleesschauwer@wiv-isp.be}{brecht.devleesschauwer@wiv-isp.be} $\mid$ Skype: \href{skype:brecht.devleesschauwer?call>}{brecht.devleesschauwer}\\
...
\begin{itemize}
  ...
  \item \textbf{Guest lecturer, health economic evaluations}, 10/2016--present \hfill \\
