...
\begin{itemize}
  ...
  \item \textbf{Guest lecturer, advanced epidemiology}, 10/2018--present \hfill \\
  ...
  \item \textbf{Guest lecturer, health economic evaluations}, 10/2016--09/2018 \hfill \\
    Universit\'{e} catholique de Louvain, Brussels, Belgium
...
\subsubsection{Institutional responsibilities}
\begin{itemize}
  \item \textbf{Project leader}, 2017--present\hfill \\
...
\begin{itemize}
  ...
  \item \textbf{Advanced epidemiology} \hfill \\
    WFSP2238, Universit\'{e} catholique de Louvain, 2018--present
