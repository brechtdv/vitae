...
\subsection{Supervision of PhD students (1)}
\begin{itemize}
  \setlength\itemsep{0em}
  \item \textbf{Sofie Theresa Thomsen}, 2016--2018 \hfill \\
    PhD Nutrition, National Food Institute, Danish Technical University \hfill \\
    Risk-benefit assessment of whole diet \hfill \\
...
cat("\\subsection{Supervision of MSc students (", nrow(db_msc), ")}\n")
...
cat("\\subsection{Supervision of BSc students (", nrow(db_bsc), ")}\n")
...
\subsection{Supervision of short-term scientific missions (4)}
\begin{itemize}
  \setlength\itemsep{0em}
...
\subsection{Member of PhD examination committees (3)}
\begin{itemize}
  \setlength\itemsep{0em}
