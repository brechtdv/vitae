...
\begin{itemize}
  ...
  \item \textbf{Senior epidemiologist, national burden of disease}, 04/2016--present \hfill \\
    Scientific Institute of Public Health (WIV-ISP), Brussels, Belgium
  \item \textbf{Guest lecturer, health economic evaluations}, 2016--2017 \hfill \\
...
\begin{itemize}
  \item FAO/WHO expert meeting on verotoxigenic \emph{Escherichia coli} (VTEC) / Shigatoxigenic \emph{E. coli} (STEC). World Health Organization, Geneva, Switzerland; 2016.
  \item Expert consultation on diet-related health problems to support the development of food-based dietary guidelines. Superior Health Council, Brussels, Belgium; 2016.
...
\begin{itemize}
  ...
  \item \textbf{Health economic evaluations} \hfill \\
    WFSP2103, Universit\'{e} catholique de Louvain, March--April, 2017
...
\begin{itemize}
  \setlength\itemsep{0em}
  \item \textbf{Burden of Disease and the DALY metric}, 5--6 October 2016 \hfill \\
