...
\begin{itemize}
  \setlength\itemsep{0em}
    \item[{[14]}] Maertens de Noordhout C, Detollenaere J, Primus-de Jong C, Kohn L, \textbf{Devleesschauwer B}, Charafeddine R, Cleemput I. Identifying Patient needs: methodological approach and application. Health Services Research (HSR) Brussels: Belgian Health Care Knowledge Centre (KCE). 2021. KCE Reports 348. D/2021/10.273/51.. \url{https://kce.fgov.be/en/identifying-patient-needs-methodological-approach-and-application}
